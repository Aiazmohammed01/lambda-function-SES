    ...
    for user in users:
        ...
        for key in access_keys:
            ...
            if access_key_status == 'Active' and access_key_expiry.date() == datetime.now().date() + timedelta(days=7):
                ...
                email_body = f"Hello {user_name},\n\nYour IAM access key ({access_key_id}) will expire in 7 days. The user has been disabled. Please rotate your access keys to ensure uninterrupted access to AWS resources.\n\nThank you."
